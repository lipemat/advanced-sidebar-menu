 ...
 * @since      9.6.0
 *
 * @todo       Step 5 of the migration plan: Once the minimum PRO version is 9.11.0+
 *
 ...
 *           4. ~~Make note in the basic version the `WidgetWithId` interface is deprecated and uses may be removed at the next PRO
 *           version.~~
 *           5. Remove uses from the basic version in favor of the `Widget` interface when required PRO version is 9.11.0+.
 *
 *
 * @deprecated 9.8.0 use `Widget` instead. Will be removed in
 *
